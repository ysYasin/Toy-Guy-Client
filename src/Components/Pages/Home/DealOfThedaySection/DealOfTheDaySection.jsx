  ...
  return (
    <div className="max-w-7xl container px-5 mx-auto py-24">
      <div className="flex justify-between">
        <h1 className="text-5xl dealotd relative font-medium">
          Deal of the day
        </h1>
      ...
      <div className="flex mt-16 items-center lg:justify-between gap-3 lg:flex-row flex-col">
        <div className="flex w-1/2 py-8 px-5 gap-5 items-center justify-around border mg:w-1/2 ">
          ...
          <div className="relative ps-4">
            ...
            <button
              ...
              className="px-5 py-3 bg-[#e5f2f2] border-dashed border-2 border-[#158aa0] text-[#158aa0] text-lg font-medium"
            >
        ...
        <div className="flex w-1/2 py-8 px-5 gap-5 items-center justify-around border mg:w-1/2 ">
          ...
          <div className="relative ps-4">
            <span className="absolute h-[150%] -top-8 -left-4 w-[2px] border-dashed border bg-transparent"></span>
            <span
              className="absolute h-[20px] top-[-37px] -left-7 border-r border-l b w-[27px] bg-white "
              style={{
                borderTopLeftRadius: "50%",
            ...
            <button
              onClick={() => setCuppon2(true)}
              className="px-5 py-3 bg-[#e5f2f2] border-dashed border-2 border-[#158aa0] text-[#158aa0] text-lg font-medium"
            >
              {cuppon2 ? "Copied" : "Happy NY24"}
            </button>
          </div>
        </div>
      </div>
      <div className="flex items-center mx-auto lg:justify-between gap-3 lg:flex-row flex-col">
        <div className="flex w-1/2 py-8 px-5 gap-5 items-center justify-around border mg:w-1/2 ">
          <div className="h-full">
            <img
              className="w-[100px] h-full"
          ...
          <div className="relative ps-4">
            ...
            <button
              onClick={() => setCuppon3(true)}
              className="px-5 py-3 bg-[#e5f2f2] border-dashed border-2 border-[#158aa0] text-[#158aa0] text-lg font-medium"
            >
              {cuppon3 ? "Copied" : "Happy NY24"}
            </button>
          </div>
        </div>
        <div className="flex w-1/2 py-8 px-5 gap-5 items-center justify-around border mg:w-1/2 ">
          ...
          <div className="relative ps-4">
            ...
            <button
              onClick={() => setCuppon4(true)}
              className="px-5 py-3 bg-[#e5f2f2] border-dashed border-2 border-[#158aa0] text-[#158aa0] text-lg font-medium"
            >
              {cuppon4 ? "Copied" : "Happy NY24"}
            </button>
          </div>
        </div>
      </div>
